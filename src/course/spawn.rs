...
fn spawn_course_from_entities<'a>(commands: &'a mut Commands, entity: &EntityData, asset_server: &AssetServer)-> EntityCommands<'a> {
    ...
    match &entity.kind {
        ...
        EntityKind::Text { sentence } => commands.spawn(text_box::text_box_bundle(x, y, sentence, asset_server)),
    }
}
